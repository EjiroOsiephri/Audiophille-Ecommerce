...
import img1 from "../../../public/Bitmap (18).png"; // Replace with the correct path
import img2 from "../../../public/Bitmap (16).png";
import img3 from "../../../public/Bitmap (15).png";
...
const FirstSpeakerGalleryComponent = () => {
  return (
...
export default FirstSpeakerGalleryComponent;
