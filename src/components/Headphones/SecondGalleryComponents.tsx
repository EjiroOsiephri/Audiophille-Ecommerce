...
import img1 from "../../../public/Bitmap (8).png"; // Replace with the correct path
import img2 from "../../../public/Bitmap (7).png";
import img3 from "../../../public/Bitmap (9).png";
...
export default SecondGalleryComponent;
